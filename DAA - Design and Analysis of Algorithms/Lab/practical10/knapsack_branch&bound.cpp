...
/* Item structure that stores the weight and value of the item */
struct Item
{
	float weight;
	int value;
...
struct Node
{
	/*
		...
		bound : upper bound of max profit in current subtree node
	*/
	int level, profit, bound;
	float weight;
};

/* Sort Item by val/weight ratio using the comparison function. */
...
/* Profit bound returns in a subtree rooted with u. The Greedy solution is mostly used in this function to determine an upper bound on maximum profit. */
